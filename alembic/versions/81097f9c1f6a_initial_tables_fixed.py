"""initial_tables_fixed

Revision ID: 81097f9c1f6a
Revises: 
Create Date: 2025-05-22 12:24:41.779734
...
def upgrade() -> None:
    ...
    # Crear tabla users sin la FK a companies primero
    ...
    # Ahora crear companies que depende de users
    ...
    # Añadir la columna id_empresa a users después de que companies exista
    op.add_column('users', sa.Column('id_empresa', sa.Integer(), nullable=True))
    op.create_foreign_key('fk_users_id_empresa', 'users', 'companies', ['id_empresa'], ['id'])

    # Resto de tablas que dependen de users y companies
...
def downgrade() -> None:
    ...
    # Primero eliminar la FK id_empresa de users
    op.drop_constraint('fk_users_id_empresa', 'users', type_='foreignkey')
